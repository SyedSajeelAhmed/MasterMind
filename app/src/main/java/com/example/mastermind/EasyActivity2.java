...
public class EasyActivity2 extends AppCompatActivity {
    ...
    private String[] keys = {"C","I","O","N","S"};
    private String textAnswer="ICONS";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.equestion2);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EasyActivity2.this,EasyActivity3.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(EasyActivity2.this,EasyActivity2.class);
                startActivity(intent);
            }
