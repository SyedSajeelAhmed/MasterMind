...
public class MediumActivity extends AppCompatActivity {
    ...
    private String[] keys = {"C","A","A","O","C"};
    private String textAnswer="CACAO";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.mquestion1);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MediumActivity.this,MediumActivity2.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(MediumActivity.this,MediumActivity.class);
                startActivity(intent);
            }
