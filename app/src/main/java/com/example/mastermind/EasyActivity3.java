...
public class EasyActivity3 extends AppCompatActivity {
    LinearLayout WinGame_layout;
    ImageButton back;
    private int prescounter = 0;
    private int maxprescounter = 5;
    private String[] keys = {"G","S","H","O","T"};
    private String textAnswer="GHOST";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.equestion3);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EasyActivity3.this,EasyActivity4.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(EasyActivity3.this,EasyActivity3.class);
                startActivity(intent);
            }
