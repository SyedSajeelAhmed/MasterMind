...
//        LEVEL One
    ...
    level01.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(MediumLevelActivity.this,MediumActivity.class);
...
//        LEVEL Two
        ...
        level02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MediumLevelActivity.this,MediumActivity2.class);
                startActivity(intent);
            }
        });
//        LEVEL TwoEnds
...
//        LEVEL Three
        ...
        level03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MediumLevelActivity.this,MediumActivity3.class);
                startActivity(intent);
            }
        });
//        LEVEL ThreeEnds
...
//        LEVEL Four
        ...
        level04.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MediumLevelActivity.this,MediumActivity4.class);
                startActivity(intent);
            }
        });
//        LEVEL FourEnds
...
//        LEVEL Five
        ...
        level05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MediumLevelActivity.this,MediumActivity5.class);
                startActivity(intent);
            }
        });
//        LEVEL FiveEnds
