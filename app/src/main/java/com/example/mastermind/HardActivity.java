...
public class HardActivity extends AppCompatActivity {
    ...
    private String[] keys = {"E","E","B","D","L","I"};
    private String textAnswer="EDIBLE";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.hquestion1);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HardActivity.this,HardActivity2.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(HardActivity.this,HardActivity.class);
                startActivity(intent);
            }
