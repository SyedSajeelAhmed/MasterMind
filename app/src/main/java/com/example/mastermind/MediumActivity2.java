...
public class MediumActivity2 extends AppCompatActivity {
    ...
    private String[] keys = {"C","L","A","S","S"};
    private String textAnswer="CLASS";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.mquestion2);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MediumActivity2.this,MediumActivity3.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(MediumActivity2.this,MediumActivity2.class);
                startActivity(intent);
            }
