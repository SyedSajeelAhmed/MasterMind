...
public class MediumActivity5 extends AppCompatActivity {
    LinearLayout WinGame_layout;
    ImageButton back;
    private int prescounter = 0;
    private int maxprescounter = 5;
    private String[] keys = {"R","N","A","I","Y"};
    private String textAnswer="RAINY";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.mquestion5);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MediumActivity5.this,HardActivity.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(MediumActivity5.this,MediumActivity5.class);
                startActivity(intent);
            }
