...
public class EasyActivity extends AppCompatActivity {
    ...
    private String[] keys = {"C","I","E","D","M"};
    private String textAnswer="MEDIC";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.equestion1);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EasyActivity.this,EasyActivity2.class);
