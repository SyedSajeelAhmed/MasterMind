...
public class HardActivity2 extends AppCompatActivity {
    ...
    private String[] keys = {"C","U","T","D","B","A"};
    private String textAnswer="ABDUCT";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.hquestion2);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HardActivity2.this,HardActivity3.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(HardActivity2.this,HardActivity2.class);
                startActivity(intent);
            }
