...
public class HardActivity5 extends AppCompatActivity {
    LinearLayout WinGame_layout;
    ImageButton back;
    private int prescounter = 0;
    private int maxprescounter = 6;
    private String[] keys = {"C","A","B","N","A","A"};
    private String textAnswer="CABANA";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.hquestion5);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HardActivity5.this,EasyActivity.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(HardActivity5.this,HardActivity5.class);
                startActivity(intent);
            }
