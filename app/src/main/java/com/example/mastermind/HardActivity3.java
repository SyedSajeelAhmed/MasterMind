...
public class HardActivity3 extends AppCompatActivity {
    LinearLayout WinGame_layout;
    ImageButton back;
    private int prescounter = 0;
    private int maxprescounter = 6;
    private String[] keys = {"C","A","E","D","S","T"};
    private String textAnswer="CADETS";
    Dialog mDialog;
    Button btn_tryagain;
...
//           Quesion
        ...
        Question_h1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialog.setContentView(R.layout.hquestion3);
...
//        BtnNextLevel
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HardActivity3.this,HardActivity4.class);
        ...
        btn_tryagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent = new Intent(HardActivity3.this,HardActivity3.class);
                startActivity(intent);
            }
